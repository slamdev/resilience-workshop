...
public class Controller {
    ...
    @io.github.resilience4j.circuitbreaker.annotation.CircuitBreaker(name = "delayedError")
    ...
    @io.github.resilience4j.retry.annotation.Retry(name = "randomError")
    ...
    @io.github.resilience4j.bulkhead.annotation.Bulkhead(name = "slowDbQuery")
